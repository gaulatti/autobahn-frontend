...
/**
 * PulsesList component renders the pulses page with a date range selector and a table of pulses.
 *
 * @component
      ...
      <Section size='1'>
        ...
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Pulses</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        <Trigger />
